...
const section1 = `
          <div className="space-y-16">
            {/* VLP Series Section */}
            {filteredProducts.finder() ? filteredProducts.filter(p => !!p.code.match(/^BLR-/i) && (parseInt(p.code.replace(/[^0-9]/g, '')) <= 78)).length > 0 && (
              <div>
